...
let allowedOrigins = ['http://localhost:*', 'http://testsite.com', 'https://myflixsethsingletary.netlify.app/', 'https://my-flix-client-five.vercel.app/', 'https://clever-pixie-e8d67c.netlify.app'];
app.use(cors({
